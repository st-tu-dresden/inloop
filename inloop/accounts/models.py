...
# This is a system-wide singleton user which can be used to associate data
# generated by automated background tasks (e.g., imports).
SYSTEM_USER, __ = UserProfile.objects.get_or_create(username="system")
