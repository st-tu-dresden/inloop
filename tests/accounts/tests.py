...
class AccountModelsTest(TestCase):
    def setUp(self):
        ...
        self.sarah = User.objects.create_user(
            username="sarah", email="sarah@example.org", password="secret"
        )
...
class PasswordRecoverWorkflowTest(SimpleAccountsData, TestCase):
    ...
    def test_recovery(self):
        ...
        self.assertIn(
            ...
            "has requested a password reset on example.com.",
            body,
        )
        self.assertIn("The INLOOP team", body)
        ...
        form_data = {"new_password1": "ji32k7au4a83", "new_password2": "ji32k7au4a83"}
        ...
        self.assertTrue(
            self.client.login(username="bob", password="ji32k7au4a83"),
