tinyMCE.addI18n({
    nn: {
        common: {
            ...
            "invalid_data_number": "{#field} m\u00e5 vere eit nummer",
            "invalid_data_min": "{#field} m\u00e5 vere eit nummer h\u00f8gare enn {#min}",
            "invalid_data_size": "{#field} m\u00e5 vere eit nummer eller ein prosent",
            value: "(verdi)"
        },
        contextmenu: {full: "Full", right: "H\u00f8gre", center: "Midtstill", left: "Venstre", align: "Justering"},
        insertdatetime: {
        ...
        print: {"print_desc": "Skriv u"},
        preview: {"preview_desc": "F\u00f8rehandsvisni"},
        directionality: {"rtl_desc": "Retning h\u00f8gre mot venstre", "ltr_desc": "Retning venstre mot h\u00f8gre"},
        layer: {
            content: "Nytt lag...",
        ...
        save: {"save_desc": "Lagre", "cancel_desc": "Kanseller alle endringar"},
        nonbreaking: {"nonbreaking_desc": "Set inn hardt mellomrom"},
        iespell: {
        ...
        emotions: {"emotions_desc": "Hum\u00f8rfjes", "delta_height": "", "delta_width": ""},
        searchreplace: {
        ...
        advimage: {"image_desc": "Set inn / endre bilete", "delta_width": "", "delta_height": ""},
        advlink: {"link_desc": "Set inn / endre lenkje", "delta_height": "", "delta_width": ""},
        xhtmlxtras: {
        ...
        autosave: {
            "warning_message": "Om du gjenopprettar lagra innhald vil du miste alt innhald som finst i tekstbehandler no.\n\nEr du sikker p\u00e5 at du ynskjer \u00e5 gjenopprette lagra innhald?",
            "restore_content": "Gjenopprett autolagra innhald",
            "unload_msg": "Endringane du gjorde g\u00e5r tapt om du forl\u00e8t denne sida!"
        },
        fullscreen: {desc: "Skift til/fr\u00e5 fullskjermmodus"},
        media: {
        ...
        fullpage: {desc: "Dokumenteigenskapar", "delta_width": "", "delta_height": ""},
        template: {desc: "Set inn f\u00f8rehandsdefinert malinnhald"},
        visualchars: {desc: "Visuelle konktrollteikn p\u00e5/av"},
        spellchecker: {
        ...
        pagebreak: {desc: "Set inn sideskift"},
        advlist: {
            types: "Types",
            def: "Default",
        ...
        aria: {"rich_text_area": "Omr\u00e5de for rik tekst"},
        wordcount: {words: "Ord:"}
    }
});