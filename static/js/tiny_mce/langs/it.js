tinyMCE.addI18n({
    it: {
        common: {
            ...
            "invalid_data_number": "{#field} deve essere un numero",
            "invalid_data_min": "{#field} deve essere un numero maggiore di {#min}",
            "invalid_data_size": "{#field} deve essere un numero o una percentuale",
            value: "(valore)"
        },
        contextmenu: {
            full: "Giustifica",
        ...
        print: {"print_desc": "Stampa"},
        preview: {"preview_desc": "Anteprima"},
        directionality: {"rtl_desc": "Direzione da destra a sinistra", "ltr_desc": "Direzione da sinistra a destra"},
        layer: {
            content: "Nuovo layer...",
        ...
        save: {"save_desc": "Salva", "cancel_desc": "Cancella tutte le modifiche"},
        nonbreaking: {"nonbreaking_desc": "Inserisci uno spazio"},
        iespell: {download: "ieSpell non rilevato. Installarlo ora?", "iespell_desc": "Esegui controllo ortografico"},
        advhr: {"advhr_desc": "Riga orizzontale", "delta_height": "", "delta_width": ""},
        emotions: {"emotions_desc": "Faccine", "delta_height": "", "delta_width": ""},
        searchreplace: {
        ...
        advimage: {"image_desc": "Inserisci/modifica immagine", "delta_width": "", "delta_height": ""},
        advlink: {"link_desc": "Inserisci/modifica collegamento", "delta_height": "", "delta_width": ""},
        xhtmlxtras: {
        ...
        style: {desc: "Modifica stile CSS", "delta_height": "", "delta_width": ""},
        paste: {
        ...
        fullscreen: {desc: "Attiva/disattiva modalit\u00e0 a tutto schermo"},
        media: {
        ...
        fullpage: {desc: "Propriet\u00e0 Documento", "delta_width": "", "delta_height": ""},
        template: {desc: "Inserisci contenuto da modello predefinito"},
        visualchars: {desc: "Attiva/disattiva caratteri di controllo visuale."},
        spellchecker: {
        ...
        pagebreak: {desc: "Inserisci intterruzione di pagina."},
        advlist: {
            types: "Tipi",
            def: "Default",
        ...
        aria: {"rich_text_area": "Area testo formattato"},
        wordcount: {words: "Parole:"}
    }
});