tinyMCE.addI18n({
    de: {
        ...
        print: {"print_desc": "Drucken"},
        preview: {"preview_desc": "Vorschau"},
        directionality: {"rtl_desc": "Schrift von rechts nach links", "ltr_desc": "Schrift von links nach rechts"},
        layer: {
            content: "Neue Ebene...",
        ...
        save: {"save_desc": "Speichern", "cancel_desc": "Alle \u00c4nderungen verwerfen"},
        nonbreaking: {"nonbreaking_desc": "Gesch\u00fctztes Leerzeichen einf\u00fcgen"},
        iespell: {
            download: "ieSpell konnte nicht gefunden werden. Soll es installiert werden?",
            "iespell_desc": "Rechtschreibpr\u00fcfung"
        },
        advhr: {"advhr_desc": "Trennlinie", "delta_height": "", "delta_width": ""},
        ...
        advimage: {"image_desc": "Bild einf\u00fcgen/ver\u00e4ndern", "delta_width": "", "delta_height": ""},
        advlink: {"link_desc": "Link einf\u00fcgen/ver\u00e4ndern", "delta_height": "", "delta_width": ""},
        xhtmlxtras: {
        ...
        style: {desc: "CSS-Styles bearbeiten", "delta_height": "", "delta_width": ""},
        paste: {
        ...
        fullscreen: {desc: "Vollbildschirm"},
        media: {
        ...
        fullpage: {desc: "Dokument-Eigenschaften", "delta_width": "", "delta_height": ""},
        template: {desc: "Inhalt aus Vorlage einf\u00fcgen"},
        visualchars: {desc: "Sichtbarkeit der Steuerzeichen an/aus"},
        spellchecker: {
        ...
        pagebreak: {desc: "Seitenumbruch einf\u00fcgen"},
        advlist: {
            types: "Typen",
            def: "Standard",
            "lower_alpha": "a. b. c.",
        ...
        aria: {"rich_text_area": "Rich Text Bereich"},
